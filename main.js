...
function createWindow () {
  ...
  mainWindow.loadURL(
    url.format({
      pathname: path.join(__dirname, `dist/ocr-detection/index.html`),
      protocol: "file:",
      slashes: true
    })
  );
...
//   let pyshel = new PythonShell('resources/app.asar/Backend/new/client_seek_csi_main.py',  function  (err, results)  {
//   if  (err)  throw err;
